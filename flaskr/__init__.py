...
def insertar_datos_iniciales():
    ...
    from .modelos import TipoDoc, Rol, Categoria, MetodoPago, db
    ...
    for categoria in categorias:
        if not Categoria.query.get(categoria["id"]):
            nueva_categoria = Categoria(id_categoria=categoria["id"], nombre=categoria["nombre"], descripcion=categoria["descripcion"])
